...
public class ProfileActivity extends BaseActivity {
    ...
    EditText edt_email_id_PD,edt_contact_PD,edt_address_PD,edt_aadhar_PD;
    LinearLayout linear_active_update,linear_update_details,linear_update,linear_cancel;
    ...
    private void setEnableEditText(boolean bool) {
        ...
        edt_email_id_PD.setEnabled(bool);
